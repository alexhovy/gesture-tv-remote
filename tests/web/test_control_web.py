...
class ControlWebTests(unittest.TestCase):
    ...
    def test_control_static_assets_are_available(self) -> None:
        ...
        self.assertIn("pointToCropPixels", read_control_js())
        self.assertIn("/api/control/layout", read_control_js())
        self.assertIn("postLayoutMetrics", read_control_js())
        self.assertIn("motionScaleX", read_control_js())
        self.assertIn("motionScaleY", read_control_js())
        self.assertIn("xMotionDistanceToCropPixels", read_control_js())
        self.assertIn("yMotionDistanceToCropPixels", read_control_js())
        self.assertIn("overlayContext.ellipse", read_control_js())
