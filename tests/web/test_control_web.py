...
class ControlWebTests(unittest.TestCase):
    ...
    def test_control_static_assets_are_available(self) -> None:
        ...
        self.assertIn("xDistanceToCropPixels", read_control_js())
        self.assertIn("yDistanceToCropPixels", read_control_js())
        self.assertIn("distance / crop.width", read_control_js())
        self.assertIn("distance / crop.height", read_control_js())
